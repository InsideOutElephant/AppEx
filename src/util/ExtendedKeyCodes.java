...
class ExtendedKeyCodes {
    ...
    private final HashMap<Integer, Integer> regularKeyCodesMap =
            new HashMap<>(98, 1.0f);
    ...
    private final HashSet<Integer> extendedKeyCodesSet =
...

    {
        ...
        extendedKeyCodesSet.add(0x01000000 + 0x06CC); // duplicate removed here
        ...
        extendedKeyCodesSet.add(0x01000000 + 0x0589);// duplicates from here
        extendedKeyCodesSet.add(0x01000000 + 0x055D);
        extendedKeyCodesSet.add(0x01000000 + 0x055B);
        extendedKeyCodesSet.add(0x01000000 + 0x055E); // to here
    ...
    private void setUpperCase(boolean b) {
        upperCase = b;
    }

    final int getExtendedKeyCodeForChar(int c) {
